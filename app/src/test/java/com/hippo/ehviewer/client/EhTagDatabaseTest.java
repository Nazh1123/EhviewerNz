...
public class EhTagDatabaseTest {
  ...
  public void locPrefixLooksUpAndSuggestsFullNamespace() throws IOException {
    ...
    assertEquals("location:沙滩", com.hippo.ehviewer.util.TagTranslationUtil.getTagCN("location:beach", db));
    assertEquals("loc:沙滩", com.hippo.ehviewer.util.TagTranslationUtil.getTagCN("loc:beach", db));
    assertEquals("沙滩", com.hippo.ehviewer.util.TagTranslationUtil.getTagCNBody(new String[] {"loc", "beach"}, db));
